            ...
            <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold tracking-tight leading-tight">
                        Building <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-green-400">Scalable</span> <br />
                        Digital Infrastructures.
                    </h1>

                    <p className="text-xl text-gray-400 max-w-lg leading-relaxed">
                        I'm <span className="text-white font-semibold">Fransi Patel</span>, a Backend Specialist & Software Developer engineering robust, secure, and high-performance systems.
                    </p>

                    <div className="flex flex-wrap gap-4">
                        <a href="#projects" className="group px-6 py-3 bg-white text-black font-semibold rounded-lg flex items-center gap-2 hover:bg-gray-200 transition-colors">
                            View Projects
                            <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                        </a>
                        <a href="/Fransi_Patel - CV.pdf" download="Fransi_Patel_CV.pdf" className="px-6 py-3 bg-white/5 text-white font-semibold rounded-lg border border-white/10 hover:bg-white/10 transition-colors flex items-center gap-2">
                            Download CV
                ...
                >
                    ...
                    <div className="relative bg-[#0F172A] border border-white/10 rounded-xl overflow-hidden shadow-2xl">
                        ...
                        <div className="flex items-center gap-2 px-4 py-3 bg-white/5 border-b border-white/5">
                            ...
                            <div className="ml-2 text-xs text-gray-400 font-mono">server@fransi-dev:~/portfolio</div>
                        ...
                        <div className="p-6 font-mono text-sm h-[320px] flex flex-col gap-2">
                            {terminalLines.map((line, i) => (
                                <motion.div
                                    ...
                                    animate={{ opacity: textIndex >= i ? 1 : 0, x: textIndex >= i ? 0 : 10 }}
